...
namespace BLL
{
    public class Menu
    {
        ...
        static private Simulation simulation = new();
        static private ChangeState changeState = new();
        static private Director director = new();
...
/*        static private bool IsObjectChoosen(int choosenObj, ConsoleKeyInfo keyInfo)
        ...
        static public void AppendObjectInDatabase(int choosenObj)
        {
            ...
            localityType = ChooseAnimalLocality();
        ...
        static public int ChooseAnimalLocality()
        {
